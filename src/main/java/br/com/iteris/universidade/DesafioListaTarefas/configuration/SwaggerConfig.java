package br.com.iteris.universidade.DesafioListaTarefas.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.iteris.universidade.DesafioListaTarefas.controller"))
